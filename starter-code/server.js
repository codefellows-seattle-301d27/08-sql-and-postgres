...
// Done in 10 mins: Complete the connection string for the url that will connect to your local postgres database
...
// Done in: 5 mins. Our pg module has a Client constructor that accepts one argument: the conString we just defined.
...
app.get('/new', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following
  //line of code? Which method of article.js is interacting with this particular piece of `server.js`?
  // What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  //Done:
  //app.get number:2.
  //CRUD = Retrieve.
  //response.sendfile : number:5
...
// Put your response here...
//Done : Loads database into the memory.
loadDB();
